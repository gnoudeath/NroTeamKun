...
//    public ArrayList<Map> doanhTrai = new ArrayList<>();
    ...
    //LIST MAP KHI GA
    public Map[] tranhngocnamec = new Map[1];
    public boolean opentranhngocnamec = true;
    public int lvtranhngocnamec = 1;
    public long topentranhngocnamec = 0;
    public Timer timertranhngocnamec = null;
    public byte cOpentranhngocnamec = (byte)3;

    public boolean flagout = false;
