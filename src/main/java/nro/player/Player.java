...
//    public Item itemLung = null;
    ...
    public boolean isChuongX3X4 = true;
...
//        System.out.println("QUANTITY ITEM BUY : " + item.quantityTemp);
    ...
    public void itemBagToBox(int index) {
        ...
        if (item != null) {
            ...
            //     }
            // } 
            if (item.template.id == 933) { //MANH VO BONG TAI
                if (indexBox != -1) {
                    removeItemBag(index);
...
//            }
    ...
    public byte getLevelPower() {
        if (this.power >= 1000010000000L) {
            return (byte) 30;
		} else if (this.power >= 500010000000L) {
            return (byte) 29;	
		} else if (this.power >= 300010000000L) {
            return (byte) 28;	
    ...
    public String getStringLevel() {
        ...
        if (this.power >= 1000010000000L) {
            return "bug game vô cực + " + percent;
		 } else if (this.power >= 5000010000000L) {
            return "bug game thần thánh + " + percent;	
		} else if (this.power >= 300010000000L) {
