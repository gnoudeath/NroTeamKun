...
public class Detu extends Player {
    ...
    public void initDetuBerus(Detu _detu, byte gender) {
        int rdHP = Util.nextInt(0, 51);
        int rdHPorKI = Util.nextInt(0, 5); //0 la hp > ki, 1: hp < ki, 2: hp = ki
        _detu.name = "Đệ tử Beerus";
        _detu.head = 508;
        _detu.gender = gender;
        _detu.power = 1500000;
        if (rdHPorKI == 4) {
    ...
    public void initDetuNgoKhong(Detu _wukhong, byte gender) {
        int rdHP = Util.nextInt(0, 53);
        int rdHPorKI = Util.nextInt(0, 5); //0 la hp > ki, 1: hp < ki, 2: hp = ki
        _wukhong.name = "wukhong";
        _wukhong.head = 462;
        _wukhong.bodypet2 = 470;
        _wukhong.legpet2 = 471;
        _wukhong.gender = gender;
        _wukhong.power = 1500000;
        if (rdHPorKI == 5) {
            _wukhong.hpGoc = 2000;
            _wukhong.mpGoc = 2000;
        } else if (rdHPorKI == 0 || rdHPorKI == 1) {
            _wukhong.hpGoc = (2000 + rdHP * 20);
            _wukhong.mpGoc = (2000 - rdHP * 20);
        } else if (rdHPorKI == 2 || rdHPorKI == 3) {
            _wukhong.hpGoc = (2000 - rdHP * 20);
            _wukhong.mpGoc = (2000 + rdHP * 20);
        } else {
        ...
        _wukhong.hp = _wukhong.hpGoc;
        _wukhong.mp = _wukhong.mpGoc;
        _wukhong.damGoc = Util.nextInt(25, 70);
        _wukhong.defGoc = (short) Util.nextInt(70, 500);
        _wukhong.critGoc = (byte) Util.nextInt(100, 101);
        _wukhong.tiemNang = 0;
        _wukhong.limitPower = 0;
        _wukhong.hpFull = _wukhong.hpGoc;
        _wukhong.mpFull = _wukhong.mpGoc;
        _wukhong.damFull = _wukhong.damGoc;
        _wukhong.defFull = _wukhong.defGoc;
        _wukhong.critFull = _wukhong.critGoc;
        _wukhong.isPet = true;
        _wukhong.isSoSinh = false;
        _wukhong.typePk = 0;
        _wukhong.isBerus = false;
        int rdSkill = Util.nextInt(0, 3);
        if (rdSkill == 0) {
            Skill Skillpet1 = new Skill();
            Skillpet1.skillId = (short) (17);
            Skillpet1.point = 1;
            Skillpet1.genderSkill = (byte) 0;
            Skillpet1.tempSkillId = (short) 0;
            Skillpet1.lastTimeUseThisSkill = 0;
            _wukhong.listSkill.add(Skillpet1);
        } else if (rdSkill == 1) {
            Skill Skillpet2 = new Skill();
            Skillpet2.skillId = (short) (14);
            Skillpet2.point = 1;
            ...
            Skillpet2.tempSkillId = (short) (2);
            Skillpet2.lastTimeUseThisSkill = 0;
            _wukhong.listSkill.add(Skillpet2);
        } else {
            Skill Skillpet3 = new Skill();
            Skillpet3.skillId = (short) (28);
            Skillpet3.point = 1;
            ...
            Skillpet3.tempSkillId = (short) (4);
            Skillpet3.lastTimeUseThisSkill = 0;
            _wukhong.listSkill.add(Skillpet3);
        }
        for (int i = 0; i < 3; i++) {
            Skill Skillpet = new Skill();
            Skillpet.skillId = (short) (-1);
            ...
            Skillpet.tempSkillId = (short) (-1);
            Skillpet.lastTimeUseThisSkill = 0;
            _wukhong.listSkill.add(Skillpet);
        }

        _wukhong.ItemBody = new Item[7];
    }
