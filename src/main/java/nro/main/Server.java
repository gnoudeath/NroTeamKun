...
public class Server {
    ...
    public int idMapRong1sao[] = {164};
    public int idMapRong2sao[] = {164};
    public int idMapRongOmega[] = {164};
    public long zoneTimeEndNRSD = 0;
    public boolean openNRSD = false;
    public boolean openHiru = false;
    public boolean opentranhngocnamec = true;
    ...
    public boolean isGiaoDich = true;
...
//                    Util.log("MAP NAME: " + maps[idMapBroly[i]].template.name + ", khu: " + _rdZone);
            ...
            TimerTask ttBLACKXuatHien = new TimerTask() {
                public void run() {
                    ...
                    Util.log("INIT BLACK XONG " + maps[91].template.name + " KHU " + _rdZoneCooler);
                    timerBLACKXuatHien.cancel();
                }
            ;
            };
            timerBLACKXuatHien.schedule(ttBLACKXuatHien, 0);
            ...
            TimerTask ttFIDE = new TimerTask() {
                public void run() {
                    ...
                    Service.gI().initRong1sao();
                    Service.gI().initRong2sao();
                    Service.gI().initRongOmega();
