...
public class DataSource {
    private static final String DB_URL = "jdbc:mysql://127.0.0.1/nro_team";
    private static final String USER = "root";
    private static final String PASS = "admin12345678";
...
//        config.addDataSourceProperty("prepStmtCacheSize", "250");
        ...
        config.addDataSourceProperty("prepStmtCacheSqlLimit", "2500");
